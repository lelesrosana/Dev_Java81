...
public class Atividade03 {
	/* 
	Tentativa de implementando com uma função para limpar a tela usando recursos da tabela ASCII
	\33 quando combinado modifica a saída do terminal
	[H  mover o cursor para o canto superior 
	[2J para apagar todo o conteúdo
	public static void limpandoTela() {
		System.out.print("\033[H\033[2J"); 
		System.out.flush();  // comando para a limpeza de buffer
	 */
