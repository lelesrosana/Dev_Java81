...
public class Atividade04 {
	...
	public static void main(String[] args) {
		...
		// Array - variavel do tipo reference pode inicializar com nulo, primitiva nao aceita nulo.	
		String [] identification = new String [] {"1° Mulher Cis", "2° Homem Cis", "3° Não Binário","4° Mulher Trans","5° Homem Trans","6° Outros"}; 
		String[] developer = new String[] {"1° Backend", "2° Frontend" , "3° Mobile", "4° FullStack"};
		
		
		System.out.println("Deseja iniciar a pesquisa? (SIM / NAO)");
		continueQuest = read.next().equalsIgnoreCase("SIM"); 					// comparando a resposta do usuário, ignorando maiusculo e minusculo
		limpatela();
